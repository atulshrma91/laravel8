      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-info card-header-icon">
            ...
            <h4 class="card-title">
              Verify Email
              <a href="{{url('translations/email/preview/verifyemail')}}" class="btn btn-info btn-sm pull-right" target="_blank">
          ...
          <div class="card-body">
            ...
            <form method="POST" id="translationsVerifyEmail" action="{{url('/translations/email/verifyemail')}}">
              @csrf
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <label for="copy_paste_url_en" class="bmd-label-floating"> Copy & paste URL</label>
                    <input class="form-control" type="text" name="translations[copy_paste_url][en]" required="true" aria-required="true" value="{{array_key_exists('copy_paste_url', $translations)?$translations['copy_paste_url']['en']:''}}">
                  </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <label for="copy_paste_url_da" class="bmd-label-floating"> Copy & paste URL</label>
                    <input class="form-control" type="text" name="translations[copy_paste_url][da]" value="{{array_key_exists('copy_paste_url', $translations)?$translations['copy_paste_url']['da']:''}}">
                  </div>
                </div>
              </div>
